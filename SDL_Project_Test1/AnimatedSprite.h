    ...
    else
    {
        ...
        else
        {
            ...
            while (!quit)
            {
                ...
                gSpriteSheetTexture.renderTexture((SCREEN_WIDTH - currentClip->w) / 2, (SCREEN_HEIGHT - currentClip->h) / 2, currentClip);
...
bool loadMedia()
{
    ...
    if (!gSpriteSheetTexture.loadFromFile("SDL_Image_Imports/foo.png"))
    {
